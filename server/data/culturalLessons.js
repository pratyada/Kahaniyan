// ─────────────────────────────────────────────────────────────
// Cultural Lessons — pre-written stories from many traditions.
//
// These are NOT generated. They are curated, hand-written for
// the Cultural Lessons section. Children should be able to hear
// the same theme (e.g. compassion to animals) across traditions
// — Hindu, Islamic, Christian, Sikh, Buddhist — to grow up
// open-minded and rooted at the same time.
//
// Each story:
//   - tradition: hindu | muslim | christian | sikh | buddhist | jain | jewish | secular
//   - theme: compassion-animals | honesty | sharing | humility | ... (groupable)
//   - title, body (with {childName} token), durationMinutes
//   - source: brief note on the tradition / origin
// ─────────────────────────────────────────────────────────────
...
export const CULTURAL_LESSONS = [
  // ─── COMPASSION TO ANIMALS ─────────────────────────────────
  {
    ...
    durationMinutes: 10,
    source: 'Hindu folk tradition · Ramayana / Krishna lore',
...
That night, {childName}, when you close your eyes, remember the little squirrel and its single grain of rice. You do not have to do big things to be a kind person. You only have to do small things, again and again, with love.`,
  },
  {
    ...
    durationMinutes: 10,
    source: 'Islamic tradition · Hadith narrated by Abdullah ibn Ja\'far',
...
That night, {childName}, remember that animals are not objects. They have feelings, and they remember kindness, and they remember when kindness is missing. The Prophet, peace be upon him, taught us that being gentle with the smallest, most voiceless creatures is one of the highest signs of a beautiful heart.`,
  },
  {
    ...
    durationMinutes: 10,
    source: 'Christian tradition · Gospel of Matthew, chapter 6',
...
That night, {childName}, when you hear a bird singing outside your window, remember what Jesus taught. The God who feeds the smallest brown sparrow is the same one who watches over you. You are seen. You are known. You are deeply, deeply loved — more than many sparrows, and more than you could ever measure.`,
  },
  {
    ...
    durationMinutes: 10,
    source: 'Buddhist tradition · Jataka tales / early life of the Buddha',
...
That night, {childName}, remember Noah. When you have power over a creature smaller than you — a pet, a beetle, a baby bird — you have a sacred duty. To protect. To feed. To watch over. To never sleep until they are safe. This is one of the oldest, holiest things a person can be: someone who takes care of those who cannot take care of themselves.`,
  },
  {
...
That night, {childName}, remember Bhai Kanhaiya. The bravest, kindest thing you can do in this world is to refuse to see other people as enemies. When you grow up, there will be many voices telling you that some people deserve kindness and others do not. Do not listen to those voices. Carry your water to everyone. That is how the world begins to heal.`,
  },
...
export function lessonsByTheme(theme) {
  return CULTURAL_LESSONS.filter((l) => l.theme === theme);
}

export function lessonsByTradition(tradition) {
  return CULTURAL_LESSONS.filter((l) => l.tradition === tradition);
}
