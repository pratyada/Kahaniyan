...
export const STORY_PROMPTS = {
  ...
  fifa26_ep14_spain_france: 'Lamine Yamal calmly scoring a goal for Spain, glowing tiki-taka passing lines on the pitch connecting all players, Spanish red and gold flags waving, Pedri orchestrating midfield like a magician, packed stadium under golden lights, beautiful football tiki-taka moment, Pixar-meets-Ghibli watercolor bedtime illustration',
...
dc_nz_ep5_facts: 'Fun illustration of a kiwi bird next to a kiwi fruit (same name!), more sheep than people ratio, first country where women voted, bungee jumping invented here, no snakes in NZ, around NZ flag',
  ...
  brave_ep1_che: 'A young man with a beret riding an old motorcycle through vast South American landscapes, passing through villages of poor families, mountains and rivers behind him, a small medical bag strapped to the bike, compassion in his eyes, warm sepia tones blending into vibrant sunset, journey of awakening, childrens book illustration style, no text',
  brave_ep2_mandela: 'Nelson Mandela walking out of prison gates into brilliant golden sunlight, arms raised in triumph, crowds of diverse South African people cheering and crying with joy, Robben Island prison behind him fading into shadow, rainbow arching over the scene symbolizing a new South Africa, warm hopeful golden light, freedom and forgiveness, childrens book illustration, no text',
  brave_ep3_gandhi: 'Mahatma Gandhi in simple white cloth bending down at the edge of the ocean to pick up a handful of salt, thousands of Indian people walking behind him stretching to the horizon, the Arabian Sea sparkling in golden sunset light, the Salt March, peaceful determination on his face, warm amber and ocean blue tones, childrens book illustration, no text',
  brave_ep4_shastri: 'A small humble man in simple white clothes standing at a radio microphone addressing the nation, Indian farmers and soldiers flanking him on either side, golden wheat fields on one side and the Indian tricolor on the other, a simple plate with one meal pushed aside symbolizing sacrifice, warm sunset tones, humility and service, Jai Jawan Jai Kisan, childrens book illustration, no text',
  brave_ep5_bhagat: 'A young man with a confident smile standing tall in a courtroom, light streaming through high windows onto his face, papers and books scattered around him, a crowd of supporters visible through the courthouse windows, the spirit of youthful courage and defiance against injustice, warm golden tones with dramatic shadow, Indian freedom movement, childrens book illustration, no text',
  brave_ep6_neet: 'Thousands of Indian students of all backgrounds marching together peacefully under a blazing summer sun, holding signs about fairness and education, a massive crowd stretching across a wide avenue, determination and unity on their young faces, books and study materials in their hands, warm golden light, people power and justice, childrens book illustration, no text',
  brave_ep7_chipko: 'Village women in colorful saris wrapping their arms around massive ancient Himalayan trees, loggers with axes standing back in surprise, lush green forest with snow-capped mountains behind, sunlight filtering through the canopy, birds nesting in the branches above, the strength of gentle protection, warm green and golden tones, Chipko movement, childrens book illustration, no text',
  brave_ep9_nimsdai: 'A Nepali mountaineer in orange climbing suit standing triumphantly on a snow-covered Himalayan summit at golden hour, prayer flags fluttering behind him, fourteen massive peaks visible in the background stretching across the horizon, clouds below at his feet, ice axe raised to the sky, the spirit of Nepal and impossible dreams, warm golden light breaking through clouds, emotional and heroic, childrens book illustration, no text',
  brave_ep8_billy_bishop: 'Toronto waterfront with CN Tower in background, families in parks by Lake Ontario, children on playgrounds, a small island airport visible, diverse community members holding signs and standing together, blue water sparkling, sunset over the city skyline, community unity protecting their neighbourhood, warm golden and lake blue tones, childrens book illustration, no text',
