...
export const STORY_PROMPTS = {
  ...
  fifa26_ep3_beautiful_game: 'Joyful children of many ethnicities and cultures playing soccer together on a lush emerald green pitch under golden stadium lights at dusk, one child dribbling past another who is smiling, a goalkeeper leaping with arms spread wide, teammates hugging after a goal, golden confetti swirling in the air, fans waving flags from every continent in the background, the spirit of fair play and friendship radiating warmth, dreamy bedtime illustration with soft starry sky above the stadium',
  fifa26_ep4_legends: 'Silhouettes of legendary footballers from different eras and genders standing together on a glowing pitch — a 1950s player in vintage boots, a modern female striker mid-kick, a young boy with a sock-ball — each radiating golden aura, the World Cup trophy shining like a star at center, their diverse national flags forming a rainbow arc above, fans of all ages united in the stands cheering together, inspirational dramatic golden hour lighting, magical childrens book illustration celebrating courage and dreams',
  fifa26_ep5_your_dream: 'A child of ambiguous ethnicity peacefully sleeping in a cozy bed, a magical dream bubble rising above showing them scoring the winning World Cup goal in a roaring stadium packed with 80000 fans, golden confetti and streamers cascading down, teammates from many countries rushing to celebrate together in a group hug, their tiny jersey showing a heart instead of a country flag symbolizing unity, the World Cup trophy glowing nearby, warm magical bedtime glow with stars and a crescent moon above, the feeling of dreams coming true',

  // Dallas FIFA
  fifa26_dallas_ep1_history: 'A vintage 1930 stadium in Uruguay magically transforming into AT&T Stadium in Arlington Texas, sepia to vibrant color, golden World Cup trophy at center, 48 nation flags waving, Texas lone star shining above, diverse fans united, warm golden sunset, childrens book illustration style',
  fifa26_dallas_ep2_city: 'Aerial dreamscape of Dallas Texas showing AT&T Stadium with its retractable roof open, Fair Park with Big Tex statue, Trinity River green trails, downtown Dallas skyline with Reunion Tower, Oak Cliff colorful streets, diverse families from Mexico Nigeria Korea Colombia together, Texas lone star flag flying, warm sunset, childrens book illustration',
  fifa26_dallas_ep3_game: 'Joyful diverse kids playing soccer on perfect green grass inside AT&T Stadium Arlington, enormous video screen above, Texas star on the field, one kid dribbling past another who is smiling, goalkeeper diving, confetti in air, fans waving flags from every continent, dreamy nighttime Texas stars through open roof, bedtime illustration style',
  fifa26_dallas_ep4_legends: 'Silhouettes of legendary footballers — Pelé with sock ball, Messi lifting trophy, Marta mid-kick, Clint Dempsey with Texas star on jersey — standing together on a glowing pitch at AT&T Stadium, golden auras, World Cup trophy shining, Texas stars above through open roof, inspirational warm childrens book illustration',
  fifa26_dallas_ep5_dream: 'A child peacefully sleeping in a cozy Texas bedroom with cowboy boots by the bed, magical dream bubble showing them scoring a World Cup goal at AT&T Stadium with roof open to starry Texas sky, 80000 fans erupting, golden confetti mixing with starlight, jersey with a heart symbol, warm magical glow, childrens bedtime illustration',

  fifa26_ep7_vozinha: 'Vozinha the goalkeeper in a shimmering golden kit making an incredible flying save, arms fully stretched, ball just touching his fingertips, Cape Verde tropical islands visible in the background with palm trees and blue ocean, a group of diverse children on the sideline looking up at him with wide eyes of wonder and admiration, warm golden sunset light streaming through clouds, a tiny Cape Verde flag waving proudly, inspirational heroic atmosphere, gentle bedtime illustration style with warm tones',
  fifa26_dallas_ep6_vozinha: 'Vozinha the goalkeeper in golden kit making a dramatic diving save inside AT&T Stadium Arlington, roof open to Texas starry sky, Cape Verde flag alongside American flag in the stands, 80000 fans on their feet cheering, diverse children in the front row looking up at him like a superhero, golden light radiating from his save, warm heroic bedtime illustration style',

  fifa26_ep6_draw: 'A Canadian flag (red maple leaf) and a Bosnian flag (blue triangle with white stars) side by side waving together in a Toronto stadium, CN Tower in the background, two kids — one wearing a red Canada jersey and one wearing a blue Bosnia jersey — shaking hands and smiling at center circle, scoreboard showing 0-0 draw, diverse families of every ethnicity cheering together in the stands, Canoe Landing Park waterfront visible with kids riding bikes, golden sunset over Toronto skyline, warm respectful sportsmanship, childrens bedtime book illustration style',
