...
const STORY_ART = {
  ...
  fifa26_ep3_dallas_city: { gradient: 'linear-gradient(135deg, #003594 0%, #c41e3a 40%, #ffffff 100%)', icon: '🏟️', accent: '#003594', prompt: 'AT&T Stadium Arlington with Texas star above, Fair Park Big Tex statue, Trinity River, diverse families in Dallas, Mexican and American flags, warm Texas sunset, childrens book illustration' },
  ...
  fifa26_ep13_norway_homecoming: { gradient: 'linear-gradient(135deg, #ba0c2f 0%, #002868 40%, #ffd700 100%)', icon: '🇳🇴', accent: '#ba0c2f', prompt: 'Norwegian football team walking through crowd of thousands waving flags in Oslo, children on shoulders, tears of pride, warm golden evening light, homecoming celebration, childrens book illustration' },
  fifa26_ep14_france_spain: { gradient: 'linear-gradient(135deg, #002395 0%, #ffffff 40%, #c60b1e 100%)', icon: '🇫🇷', accent: '#002395', prompt: 'Mbappe sprinting past defenders under stadium lights, French tricolor flag flowing, Spanish players watching in admiration, electric energy, golden ball trail, childrens book illustration' },
  fifa26_ep15_england_argentina: { gradient: 'linear-gradient(135deg, #cf142b 0%, #ffffff 30%, #75aadb 100%)', icon: '⚽', accent: '#cf142b', prompt: 'Dramatic last-minute goal scene, football hitting the net, half the stadium in English white and half in Argentine blue stripes, clock showing 90 minutes, gasping crowd, golden floodlights, childrens book illustration' },
  ...
  fifa26_ep17_finals_ready: { gradient: 'linear-gradient(135deg, #ffd700 0%, #002395 40%, #75aadb 100%)', icon: '🏆', accent: '#ffd700', prompt: 'Golden World Cup trophy gleaming on a pedestal at centre of a magnificent stadium, French and Argentine flags on either side, stars twinkling above, magical anticipation, childrens book illustration' },
