...
const STORY_ART = {
  ...
  fifa26_ep14_spain_france: { gradient: 'linear-gradient(135deg, #c60b1e 0%, #ffc400 40%, #002395 100%)', icon: '🇪🇸', accent: '#c60b1e', prompt: 'Lamine Yamal scoring a calm goal for Spain, tiki-taka passing lines glowing on the pitch, Spanish red and gold flags, French players watching in admiration, beautiful football, childrens book illustration' },
