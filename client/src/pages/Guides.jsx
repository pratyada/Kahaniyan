...
const GUIDES = [
  {
    id: 'first-night',
    icon: '🌙',
    title: 'Your first bedtime with Kahaniyo',
    audience: 'New parents',
    summary: 'A 5-minute setup that turns Kahaniyo into part of your nightly ritual.',
    body: [
      'Open Kahaniyo about 15 minutes before bedtime — give your child time to settle.',
