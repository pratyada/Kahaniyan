// Studio — 33-day content calendar & creative pipeline for social media.
...
const INSTAGRAM_PLAN = [
  { day: 1, date: 'Jun 05', title: 'Why Audio Stories Help Kids Learn', reel: 'A cozy bedroom at night, soft golden lamp light, gentle illustrated sound waves flowing toward a sleeping child, storybook pages floating in the air, warm watercolor style, dreamy and calm.', voiceover: 'Did you know? Children remember stories they hear three times better than stories they read. Audio bedtime stories build vocabulary, spark imagination, and calm a racing mind. When your child listens to a narrated tale at bedtime, their brain lights up the same way it does during deep, focused learning. That is the magic of audio stories. Learning that feels like resting.', caption: 'Did you know? Children remember stories they hear 3x better than stories they read. Audio bedtime stories build vocabulary, spark imagination, and calm a racing mind — all while your child drifts to sleep. That is the magic of My Sleepy Tale. Learning that feels like resting.', cta: 'Try a free bedtime story tonight. Link in bio. Follow @mysleepytale_official', hashtags: '#bedtimestories #audiostories #kidslearning #sleepstories #parentingtips #earlylearning #mysleepytale', status: 'todo' },
  { day: 2, date: 'Jun 06', title: 'How Bedtime Stories Build Empathy', reel: 'Two children silhouettes sitting together under a glowing tree, listening to floating story characters around them, soft amber light, watercolor style, dreamy, no faces, no text.', voiceover: 'When a child hears a story about someone different from them, something beautiful happens. They feel what that character feels. They understand without being told. Bedtime stories do not just teach words. They teach hearts. One story at a time, your child learns kindness, courage, and compassion.', caption: 'Bedtime stories teach more than words. They teach hearts. When your child hears a story about someone different — they feel what that character feels. That is empathy. One story at a time, your child learns kindness, courage, and compassion.', cta: 'Start building empathy tonight. Free bedtime stories at link in bio. Follow @mysleepytale_official', hashtags: '#empathy #kidsempathy #bedtimestories #raisingkindkids #parentingtips #emotionalintelligence #mysleepytale', status: 'todo' },
  { day: 3, date: 'Jun 07', title: 'Why Cultural Stories Matter', reel: 'A mosaic of glowing storybook windows, each showing a different cultural scene — a mosque dome, temple bells, church steeple, Filipino landscape, Hispanic garden — warm connected glow, watercolor, no text, no faces.', voiceover: 'Every child deserves to hear stories from their own culture. Stories about their traditions, their heroes, their roots. But they also deserve to hear stories from other cultures. Because when a Hindu child hears an Islamic tale, or a Filipino child hears a Jewish one, they learn that kindness looks the same everywhere. That is what My Sleepy Tale is for.', caption: 'Every child deserves to hear stories from their own roots. But also from others. Because when a Hindu child hears an Islamic tale, or a Filipino child hears a Jewish one — they learn that kindness looks the same everywhere. 11 traditions. 146+ stories. All free.', cta: 'Explore stories from your culture tonight. Free at link in bio. Follow @mysleepytale_official', hashtags: '#culturalstories #diversekidsbooks #representation #bedtimestories #hindukids #islamickids #filipinokids #mysleepytale', status: 'todo' },
  { day: 4, date: 'Jun 08', title: 'The Last Train Home', reel: 'POV out a rain-streaked train window at night; warm carriage light; distant lights blurring past; title fades in.', voiceover: 'The last train of the night is almost empty. Rain taps the glass. The seat is warm. You don\'t have to be anywhere now\u2026 just here.', caption: 'Tonight\'s story: The Last Train Home. \ud83d\ude82 A quiet carriage, rain on the windows, and nowhere you need to be. Let the rhythm of the rails carry you under.', cta: '\ud83c\udf19 Full story \u2192 link in bio. Already drifting? DM us ONE word for how it made you feel. \ud83d\udca4', hashtags: '#sleepstories #bedtimestories #fallasleepfast #sleephelp #calm #insomniarelief #cozyvibes #mysleepytale', status: 'todo' },
  { day: 5, date: 'Jun 09', title: 'The Lighthouse Keeper', reel: 'Slow pan of a lighthouse beam sweeping over a dark calm sea; stars; gentle waves below.', voiceover: 'High on the cliff, the lighthouse turns its slow, patient light. The sea breathes below. Tonight you are kept safe. Tonight you can rest.', caption: 'Tonight\'s story: The Lighthouse Keeper. \ud83c\udf0a One steady light, one quiet sea, one slow breath after another.', cta: '\ud83c\udf19 Full story \u2192 link in bio. Already drifting? DM us ONE word for how it made you feel. \ud83d\udca4', hashtags: '#sleepstory #cantsleep #relaxation #sleepaid #nighttimeroutine #unwind #sleepbetter #mysleepytale', status: 'todo' },
  { day: 6, date: 'Jun 10', title: 'A Cabin in the Snow', reel: 'Crackling fireplace, embers glowing; snow falling past a frosted window; warm amber light.', voiceover: 'Snow falls without a sound. Inside, the fire settles into embers. The blanket is heavy and warm. Outside, the whole world is sleeping too.', caption: 'Tonight\'s story: A Cabin in the Snow. \u2744\ufe0f\ud83d\udd25 Snowfall, firelight, and the softest place to let your thoughts go quiet.', cta: '\ud83c\udf19 Full story \u2192 link in bio. Already drifting? DM us ONE word for how it made you feel. \ud83d\udca4', hashtags: '#bedtime #sleeptok #asmrvibes #winddown #restwell #sleepmeditation #cozyaesthetic #mysleepytale', status: 'todo' },
  { day: 7, date: 'Jun 11', title: 'The Tea Garden', reel: 'Japanese garden at dusk; paper lanterns glowing; soft rain on stone; koi-pond ripples.', voiceover: 'Rain falls gently on the garden stones. A lantern glows. Steam rises from a cup left to cool. There is nowhere to rush, nothing to solve.', caption: 'Tonight\'s story: The Tea Garden. \ud83c\udfee Lantern light, soft rain, and the slow art of doing nothing at all.', cta: '\ud83c\udf19 Full story \u2192 link in bio. Already drifting? DM us ONE word for how it made you feel. \ud83d\udca4', hashtags: '#sleepstories #bedtimestories #fallasleepfast #sleephelp #calm #insomniarelief #cozyvibes #mysleepytale', status: 'todo' },
  { day: 8, date: 'Jun 12', title: 'Drifting (a boat under stars)', reel: 'A small boat on glassy dark water; Milky Way above; slow ripples; lantern on the bow.', voiceover: 'The oars are still. The water carries you. Above, a thousand stars. Below, their reflections. You are floating between two skies.', caption: 'Tonight\'s story: Drifting. \u2728 A boat, still water, and more stars than you can count. Nothing to steer. Nothing to decide.', cta: '\ud83c\udf19 Full story \u2192 link in bio. Already drifting? DM us ONE word for how it made you feel. \ud83d\udca4', hashtags: '#sleepstory #cantsleep #relaxation #sleepaid #nighttimeroutine #unwind #sleepbetter #mysleepytale', status: 'todo' },
  { day: 9, date: 'Jun 13', title: 'The Old Bookshop', reel: 'Camera drifts down a narrow aisle of old books; dust motes in lamplight; leather spines; a cat asleep on a stack.', voiceover: 'The door closes behind you. The air smells of old paper and lamp oil. Somewhere, a clock ticks very slowly. You can stay as long as you like.', caption: 'Tonight\'s story: The Old Bookshop. \ud83d\udcda Leather spines, lamplight, and a clock that has all the time in the world.', cta: '\ud83c\udf19 Full story \u2192 link in bio. Already drifting? DM us ONE word for how it made you feel. \ud83d\udca4', hashtags: '#bedtime #sleeptok #asmrvibes #winddown #restwell #sleepmeditation #cozyaesthetic #mysleepytale', status: 'todo' },
...
export default function Studio() {
  ...
  const WEEKS = [
    { id: 1, label: 'Week 1', days: [1, 2, 3, 4, 5, 6, 7], range: 'Jun 5 – 11' },
    { id: 2, label: 'Week 2', days: [8, 9, 10, 11, 12, 13, 14], range: 'Jun 12 – 18' },
    { id: 3, label: 'Week 3', days: [15, 16, 17, 18, 19, 20, 21], range: 'Jun 19 – 25' },
    { id: 4, label: 'Week 4', days: [22, 23, 24, 25, 26, 27, 28], range: 'Jun 26 – Jul 2' },
    { id: 5, label: 'Week 5', days: [29, 30, 31, 32, 33], range: 'Jul 3 – 8' },
  ];
