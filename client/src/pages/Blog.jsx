...
const POSTS = [
  { slug: 'vozinha-cape-verde-world-cup-hero', title: 'Vozinha — The 40-Year-Old Goalkeeper Who Became a World Cup Hero', desc: 'The incredible true story of Vozinha, a 40-year-old goalkeeper from Cape Verde who faced 27 shots, saved every one on target, and inspired the world at FIFA World Cup 2026. A bedtime story about courage, perseverance, and never giving up.', cat: 'culture', tag: 'FIFA 2026', min: 8, img: 'https://mysleepytale.com/og/vozinha-hero.jpg', featured: true },
  ...
  { slug: 'kindergarten-learning-through-bedtime-stories', title: 'How Bedtime Stories Become Learning Tools — A Kindergarten Framework', desc: 'JK → SK → Grade 1 cognitive development through bedtime storytelling. Word Collectors, Sentence Builders, Story Makers — with real examples from the Rainbow class at JLPS.', cat: 'toronto', tag: 'Education', min: 12, img: 'https://firebasestorage.googleapis.com/v0/b/qissaa-61a78.firebasestorage.app/o/story-gallery%2Frk_ep1_canoe%2F1779129759962_0.jpeg?alt=media&token=df4fa13e-7b64-4860-bb65-61a300f6da93', section: 'more' },
  { slug: 'screen-free-bedtime-routines', title: '5 Screen-Free Bedtime Routines That Actually Work', desc: 'Blue light, stimulation, and the science behind why screens before bed are harmful — plus 5 routines that actually help kids sleep.', cat: 'guide', tag: 'Guide', min: 8, img: 'https://images.unsplash.com/photo-1515488042361-ee00e0ddd4e4?w=600&h=380&fit=crop&q=80', section: 'guides' },
  { slug: 'hispanic-bedtime-stories-for-kids', title: 'Hispanic Bedtime Stories for Kids — Latino Folklore & Cultural Tales', desc: 'El Coquí, Quetzalcoatl, Abuela\'s Tamales, Día de los Muertos — 25 stories rooted in Hispanic/Latino traditions, personalized with your child\'s name.', cat: 'culture', tag: 'Hispanic', min: 9, img: 'https://images.unsplash.com/photo-1590080875515-8a3a8dc5735e?w=600&h=380&fit=crop&q=80', section: 'culture' },
];
