...
export default async function handler(req, res) {
  ...
  const ADMIN_EMAILS = (process.env.ADMIN_EMAILS || 'prateekyadav2010@gmail.com,sahil.faraz@gmail.com,deepti.ramaul@gmail.com,rakshajoshi476@gmail.com').split(',').map(e => e.trim().toLowerCase());
